...
<<<<<<< HEAD
The suite collects 1647 tests, and `tests/test_documented_counts.py` holds that
=======
The suite collects 1650 tests, and `tests/test_documented_counts.py` holds that
>>>>>>> origin/main
